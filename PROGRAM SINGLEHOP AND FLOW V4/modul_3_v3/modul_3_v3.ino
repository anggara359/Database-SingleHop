...
//  radio.openReadingPipe(1, beforeModuleId);
  ...
  void lcd() {
    ...
    display.println(dataCounterModul2);
    display.display();
  }
...
//  Serial.println(dataCounterDisplayModul1);

//  if (ct - rtimer0 >= timer0  >= interval && dataCounterModul2 < 8) {
//    kirimnrf();
//    rtimer0 = ct;
//  }

  if (ct2 - rtimer1 >= timer1  >= interval && dataCounterModul3 < 8) {
    kirimnrf2();
    rtimer1 = ct2;
  }
